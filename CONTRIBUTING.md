# Contributing to MarkLogic JDBC Driver

MarkLogic JDBC Driver welcomes new contributors. This document will guide you through the process.

 - [Issues and Bugs](#found-an-issue)
 - [Building from Source](#building-the-driver-from-source)
...
##### You clone from the github.com/marklogic/ml-jdbc-driver repo
...
```bash
$ git remote add upstream git://github.com/marklogic/ml-jdbc-driver.git
```
...
Fork the project [on GitHub](https://github.com/marklogic/ml-jdbc-driver/fork) and clone your copy.

```sh
$ git clone git@github.com:username/ml-jdbc-driver.git
$ cd ml-jdbc-driver
$ git remote add upstream git://github.com/marklogic/ml-jdbc-driver.git
```
...
```
Fixing Issue #123: make the whatchamajigger work in MarkLogic
...
This license is for your protection as well as the protection of MarkLogic and its licensees. This Agreement does not otherwise change your rights to use your own Contributions for any other purpose.

#### Submit the pull request

Go to https://github.com/username/ml-jdbc-driver and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic-community/ml-jdbc-driver/issues
