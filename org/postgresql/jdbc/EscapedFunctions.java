...
public class EscapedFunctions {
  ...
  /**
   * database to database-name(xdmp:database()) translation
   *
   * @param parsedArgs arguments
   * @return sql call
   * @throws SQLException if something wrong happens
  ...
  public static String sqldatabase(List<?> parsedArgs) throws SQLException {
    ...
    return "xdmp_database_name(xdmp_database())";
  }
...
/*
ML9.0-5
sys.sys_functions.name	sys.sys_functions.nargs	sys.sys_functions.type
abs	1	scalar
acos	1	scalar
ascii	1	scalar
asin	1	scalar
...
cot	1	scalar
count	2	scalar
current_date	0	scalar
current_time	0	scalar
current_timestamp	0	scalar
dateadd	3	scalar
datediff	3	scalar
datepart	2	scalar
day	1	scalar
...
pg_client_encoding	0	scalar
pg_type_id	1	scalar
pg_type_size	1	scalar
pi	0	scalar
power	2	scalar
quarter	1	scalar
radians	1	scalar
...
sum	2	scalar
tan	1	scalar
timestampadd	3	scalar
timestampdiff	3	scalar
trim	2	scalar
truncate	2	scalar
ucase	1	scalar
user	0	scalar
