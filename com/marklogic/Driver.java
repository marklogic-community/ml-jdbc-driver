...
public class Driver implements java.sql.Driver {
  ...
  public java.sql.Connection connect(String url, Properties info) throws SQLException {
    ...
    if (!url.startsWith("jdbc:marklogic:")) {
      return null;
    }
    try {
    ...
    try {
      ...
      Thread thread = new Thread(ct, "MarkLogic JDBC driver connection thread");
  ...
  public static Properties parseURL(String url, Properties defaults) {
    ...
    if (!l_urlServer.startsWith("jdbc:marklogic:")) {
      return null;
    }
    l_urlServer = l_urlServer.substring("jdbc:marklogic:".length());
